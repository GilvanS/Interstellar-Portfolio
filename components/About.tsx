    ...
    <section id="about" className="py-24 scroll-mt-24">
      <div className="p-8 md:p-16 rounded-3xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-2/2 space-y-8">
            ...
            <div className="space-y-6 text-white text-lg md:text-xl font-body leading-relaxed">
              <p>
            ...
            <div className="bg-white/10 p-8 rounded-2xl border border-white/20 space-y-4 backdrop-blur-md shadow-2xl">
              <h4 className="text-accent font-display text-[11px] tracking-[0.4em] uppercase font-black">Core Especializado</h4>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6">
              {skills.map((skill, idx) => (
                <div key={idx} className="bg-white/5 p-5 rounded-2xl border border-white/20 hover:border-primary/60 transition-all group hover:-translate-y-1 backdrop-blur-sm">
                  <div className={`${skill.color} text-2xl mb-3 group-hover:scale-110 transition-transform`}>
                    <i className={skill.icon}></i>
                  </div>
                  <div className="text-[9px] text-slate-200 font-display font-bold tracking-widest mb-1 uppercase">
                    {skill.label}
                  </div>
