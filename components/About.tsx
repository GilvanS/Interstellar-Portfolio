      ...
      <div className="p-8 md:p-16 rounded-3xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 group">
              ...
              <div className="relative w-full h-full rounded-full border-4 border-slate-800 overflow-hidden shadow-[0_0_40px_rgba(0,195,255,0.15)] group-hover:shadow-[0_0_60px_rgba(0,195,255,0.3)] transition-all duration-500 bg-slate-900/80">
                <img 
                  ...
                  className="w-full h-full object-cover transition-all duration-700 scale-105 group-hover:scale-110 grayscale-[20%] group-hover:grayscale-0 brightness-110"
                  onError={(e) => {
                    e.currentTarget.src = "https://raw.githubusercontent.com/Gilvan-Sousa/Gilvan-Sousa/main/gilvan.jpg";
                  }}
                />
          ...
          <div className="w-full lg:w-2/3 space-y-8">
            ...
            <div className="space-y-6 text-slate-200 text-lg md:text-xl font-body leading-relaxed">
              <p>
                Sou <span className="text-white font-semibold">Analista de Testes Sênior há 8 anos</span>, especialista em <span className="text-primary font-medium underline underline-offset-4 decoration-primary/30">Quality Assurance</span> focado em ecossistemas de <span className="text-white font-semibold">Meios de Pagamento e Varejo</span>.
              </p>
              
              <p className="text-slate-400 text-base md:text-lg">
                Minha expertise abrange todo o ciclo de vida do software, desde testes manuais até arquiteturas complexas de automação Web/Mobile e core bancário em Mainframe (Vision Plus).
              </p>
            </div>

            <div className="bg-white/5 p-8 rounded-2xl border border-white/5 space-y-4 backdrop-blur-sm">
              <h4 className="text-accent font-display text-[10px] tracking-[0.4em] uppercase opacity-70">Core Especializado</h4>
              <p className="text-slate-300 text-base font-body leading-relaxed">
                Domínio profundo de <span className="text-white font-bold">Vision Plus (Mainframe/Mocha)</span> e injeção transacional <span className="text-white font-bold">ISO 8583</span>.
              </p>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6">
              {skills.map((skill, idx) => (
                <div key={idx} className="bg-white/5 p-5 rounded-2xl border border-white/5 hover:border-primary/40 transition-all group hover:-translate-y-1 backdrop-blur-sm">
                  <div className={`${skill.color} text-2xl mb-3 group-hover:scale-110 transition-transform`}>
                    <i className={skill.icon}></i>
                  </div>
                  <div className="text-[9px] text-slate-500 font-display font-bold tracking-widest mb-1 uppercase">
                    {skill.label}
                  </div>
                  <div className="text-white font-semibold text-xs font-body">
                    {skill.value}
                  </div>
                </div>
              ))}
