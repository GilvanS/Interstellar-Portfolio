...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-24 pt-16 pb-12 border-t border-white/5">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/Gilvan-Sousa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-slate-900/50 flex items-center justify-center text-slate-500 hover:text-primary hover:border-primary/40 border border-white/5 transition-all">
              <i className="fab fa-github"></i>
            </a>
            <a href="#" className="w-10 h-10 rounded-lg bg-slate-900/50 flex items-center justify-center text-slate-500 hover:text-primary hover:border-primary/40 border border-white/5 transition-all">
              <i className="fab fa-linkedin"></i>
            </a>
            <a href="https://wa.me/5511982371339" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-slate-900/50 flex items-center justify-center text-slate-500 hover:text-primary hover:border-primary/40 border border-white/5 transition-all">
          ...
          <ul className="space-y-4 text-sm">
            <li>
              ...
              <a 
                ...
                className="text-slate-500 hover:text-primary transition-colors font-display tracking-widest uppercase flex items-center gap-2 text-left cursor-pointer"
              >
                Baixar Currículo <span className="material-symbols-outlined text-xs">download</span>
              </a>
            </li>
            <li><a href="https://github.com/Gilvan-Sousa" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-primary transition-colors font-display tracking-widest uppercase">Github Repo</a></li>
          </ul>
        </div>
      </div>

      <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-white/5 text-[10px] font-display font-bold tracking-[0.3em] text-slate-700 uppercase">
        <div>© 2024 Gilvan Sousa. All Rights Reserved.</div>
        <div className="flex items-center gap-2">
          Quality Assured <i className="fas fa-shield-check text-primary/30"></i> For the cosmos
        </div>
      </div>
    </footer>
  );
